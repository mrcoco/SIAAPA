...
$config['DX_website_name'] = 'Information Center of PT AA Pialang Asiransi';
//$config['DX_website_name'] = get_aap_config('DX_website_name');
$config['DX_webmaster_email'] = 'webmaster@aapialang.co.id';
...
$config['DX_users_table'] = 'aap_users';
$config['DX_user_profile_table'] = 'aap_user_profile';
$config['DX_user_temp_table'] = 'aap_user_temp';
$config['DX_user_autologin'] = 'aap_user_autologin';
$config['DX_roles_table'] = 'aap_roles';
$config['DX_permissions_table'] = 'aap_permissions';
$config['DX_login_attempts_table'] = 'aap_login_attempts';
$config['AAP_config'] = 'aap_config';
...
$config['DX_recaptcha_public_key'] = '6LevJ9MSAAAAAKBf_ELLru1brOUl3XXMbRSlY55w'; 
$config['DX_recaptcha_private_key'] = '6LevJ9MSAAAAABMiaqgUvYovIAHxUoA5CNT_N7rC';
...
$config['DX_change_password_success_view'] = 'dashboard';
...
$config['header_view'] = 'dashboard/header';
$config['footer_view'] = 'dashboard/footer';

//Dashboard
$config['sidebar'] = 'dashboard/sidebar';
$config['notice'] = 'dashboard/notice';
$config['stats'] = 'dashboard/stats';
$config['page_index_head'] = 'dashboard/page_index_head';
$config['page_index_foot'] = 'dashboard/page_index_foot';
