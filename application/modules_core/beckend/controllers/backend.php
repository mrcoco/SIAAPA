...
class Backend extends CI_Controller
{
	...
	function unactivated_users()
	{
		...
		// Load view
		$this->_vi('backend/unactivated_users', $data);
	}
	...
	function uri_permissions()
	{
		...
		// Load view
		$this->_vi('backend/uri_permissions', $data);
	}
	...
	function custom_permissions()
	{
		...
		// Load view
		$this->_vi('backend/custom_permissions', $data);
	}
}
?>