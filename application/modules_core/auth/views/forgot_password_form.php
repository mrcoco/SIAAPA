                    ...
                    <div class="span12">
                        <div class="row-fluid">
                            ...
                            <div class="span12 controls">
                                <input name="login" type="text" placeholder="Enter your Username or Email Address"  />
                                    <?php echo form_error($login['name']); ?>
<!--                                <button class="btn btn-success" href="http://aapialang.co.id/icare">Back to Login</button>-->
                                <button type="submit" name="reset" class="btn btn-info right" id="loginBtn"><span class="icon16 icomoon-icon-enter white"></span> Reset Now</button>
                ...
                <div class="alert alert-error">
                                ...
                                <strong>Note : </strong> <?php echo $this->dx_auth->get_auth_error(); ?>
                </div>
